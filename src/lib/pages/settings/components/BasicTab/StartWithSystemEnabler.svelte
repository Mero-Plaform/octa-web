...
<div class="flex gap-2 flex-wrap justify-center">
  <div class="text-xs   bg-white text-yellow-500 p-2 rounded-md cursor-default">Start with system</div>
  <span
    class:opacity-50={$basicSettingsStore.startWithSystem}
  ...
  <SlideToggle
    ...
    bind:checked={$basicSettingsStore.startWithSystem}
  />
  <span
    class:opacity-50={!$basicSettingsStore.startWithSystem}
    class="cursor-default text-xs bg-white rounded-md p-2 text-yellow-500"
