...
>
  ...
  <div class="p-2 border-2 border-purple-300 rounded-md">
    <textarea
      ...
      class="w-full text-purple-800 resize-none p-2 rounded-md outline-none bg-purple-400 bg-opacity-50 focus:bg-purple-300 hover:bg-purple-300 transition-all placeholder:text-purple-950"
      rows="3"
